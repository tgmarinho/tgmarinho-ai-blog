...
### Mid-2024 — Cursor: AI finally moved into the editor

The jump to **Cursor** is what shattered the copy-paste ceiling.
...
Today my core is **Claude Code + Pi.dev**. But in parallel I'm testing everything that might improve how I work with code and agents: **Cursor, Conductor, cmux, Zed, Superset, Orca**. Each with its own character — and may the best one win for *my* workflow.
...
- **Context is the lever.** ChatGPT with no context → Cursor with the repository → agents with a terminal and PRs. The whole evolutionary line is about giving AI more context.
