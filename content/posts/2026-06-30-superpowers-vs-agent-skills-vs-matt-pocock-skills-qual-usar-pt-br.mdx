...
**Nota de transparência:** este artigo foi produzido com IA. O repositório de comparação e os benchmarks foram executados por agentes usando apenas as skills mencionadas neste texto, sem skills adicionais de React, React Patterns, Next.js ou Vercel como juízes durante a execução original. A revisão do autor focou em coerência, clareza, evidências citadas e consistência do texto. Ainda existe trabalho a fazer: revisar com mais rigor a qualidade dos resultados produzidos, aplicar rubricas especializadas depois da implementação e estudar com mais profundidade as skills dos autores.
