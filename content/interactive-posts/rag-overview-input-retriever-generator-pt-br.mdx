...
description: "Um overview denso sobre RAG (Retrieval-Augmented Generation): o porquê da arquitetura existir, o pipeline de ingestão offline, o fluxo de consulta online, embeddings, similaridade por cosseno, HNSW, chunking e por que tudo isso reduz alucinação."
date: "2026-05-22"
published: true
...
Esse post é um overview denso do RAG do começo ao fim — a motivação, a arquitetura mínima, o pipeline de ingestão offline, o fluxo de consulta online, e os conceitos que sustentam tudo (embeddings, similaridade por cosseno, HNSW, chunking).
...
### B. Normalização da query

O sistema transforma a entrada do usuário numa query textual estável: remove ruído de interface, preserva a intenção e deixa claro o que será embeddado.
